  ...
  return (
    <nav className="w-full border-b-[6px] border-black px-0 pt-4 z-50 bg-inherit">
      <div className="flex items-end justify-between h-full px-6">
        ...
        <div className="md:hidden flex w-full justify-end pb-2">
          <button 
            onClick={() => setIsOpen(true)}
            className="p-2 border-[3px] border-black bg-white rounded-lg shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-x-[3px] active:translate-y-[3px] transition-all"
          >
            <Menu size={28} />
          </button>
        </div>
      ...
      <div className={`fixed inset-0 z-[100] ${isOpen ? 'visible' : 'invisible'} md:hidden`}>
        ...
        {/* Menu Panel - Added overflow-x-hidden here to kill the scroll! */}
